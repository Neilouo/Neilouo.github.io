...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <article className="group rounded-card border border-warm-100 dark:border-warm-800 bg-white dark:bg-warm-950 hover:border-accent/30 dark:hover:border-accent/30 hover:shadow-card-hover transition-all overflow-hidden">
      <div className="p-5 space-y-3">
        ...
        <p className="text-sm text-warm-600 dark:text-warm-300 leading-relaxed line-clamp-2">
          {project.description}
        </p>
