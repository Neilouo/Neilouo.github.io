...
import QuickFilters from '../../components/note/QuickFilters'
import KnowledgeMap from '../../components/note/KnowledgeMap'
import LearningJourney from '../../components/note/LearningJourney'
import Highlights from '../../components/note/Highlights'
import UtilityDeck from '../../components/note/UtilityDeck'
...
const areaCount = Object.values(dt).filter((value) => typeof value === 'string').length
...
<div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900 text-white">
  ...
  <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-16 px-4 pb-24 pt-16">
    ...
    <KnowledgeMap json={dt} stats={knowledgeStats} />
